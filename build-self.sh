...
java -jar ./build/libs/jxe-all.jar --only-instrumented src/main/java selfhosted/stage1
...
java -jar ./selfhosted/stage1/jxe --only-instrumented src/main/java selfhosted/stage2
...
java -jar ./selfhosted/stage2/jxe --only-instrumented src/main/java selfhosted/stage3
